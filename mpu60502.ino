...
*/
  data = '|'+(String)fNewRoll + '|' + (String)fNewPitch + '|' +  (String)(realVals[0]*9.81) + '|' + (String)(realVals[1]*9.81) + '|' +(String)(realVals[2]*9.81) ;
  BT.println(data);
  Serial.println(data);
/*
  sumRoll += fNewRoll ;
  ...
  if(count == 100){
    count = 0;
    Serial.print(" average Roll : ");Serial.print(sumRoll/100);
    Serial.print(" average Pitch : ");Serial.println(sumPitch/100);
    sumRoll = 0 ;
    sumPitch = 0;
  }
*/
